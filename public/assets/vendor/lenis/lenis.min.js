/* Lenis 1.1.14 — dibungkus IIFE.
   Berkas dist aslinya bukan UMD: deklarasi tingkat atasnya (termasuk `class L`)
   bocor sebagai binding global dan MENUTUPI window.L milik Leaflet, sehingga
   L.map() lenyap. Pembungkus ini menahan semuanya di dalam; ekspor globalnya
   tetap jalan karena berkasnya diakhiri `globalThis.Lenis = L`. */
(function(){
