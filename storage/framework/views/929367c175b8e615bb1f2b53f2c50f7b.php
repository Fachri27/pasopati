    ...
    <div class="my-6" x-data="{ lang: 'id' }">
        <div class="max-w-7xl mx-auto bg-white py-8 mb-20 px-8 rounded-xl shadow-md">
            ...
            <nav class="text-sm text-gray-600 mb-6 flex items-center gap-2">
                <a href="<?php echo e(route('deforestory.index')); ?>" class="text-gray-800 hover:text-blue-600 font-medium">Deforestory</a>
                <span class="text-gray-400">›</span>
                <a href="<?php echo e(route('deforestory.laporan.index', ['caseSlug' => $caseSlug])); ?>" class="text-gray-800 hover:text-blue-600 font-medium">Laporan /<?php echo e($caseSlug); ?></a>
                <span class="text-gray-400">›</span>
                <span class="text-blue-600 font-semibold"><?php echo e($laporan ? '✏️ Edit' : '➕ Tambah'); ?></span>
            </nav>

            <h1 class="text-2xl font-bold mb-8 text-gray-700">
                <?php echo e($laporan ? '✏️ Edit Laporan' : '➕ Tambah Laporan'); ?>

                <span class="text-gray-400 font-normal text-base">— kasus /<?php echo e($caseSlug); ?></span>
            </h1>
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="bg-gray-50 border rounded-xl p-5 space-y-4 sticky top-6">
                            ...
                            <div x-show="lang === 'id'" x-data="{
                                title: <?php echo \Illuminate\Support\Js::from(old('title_id', $title_id ?? ''))->toHtml() ?>,
                                slug: <?php echo \Illuminate\Support\Js::from(old('slug', $slug ?? ''))->toHtml() ?>,
                                makeSlug(text) {
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['title_id'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                <p class="text-xs text-gray-400 mt-1">URL: /deforestory/<?php echo e($caseSlug); ?>/<span x-text="slug"></span></p>
                            </div>
                            ...
                            <div x-show="lang === 'en'">
                                ...
                                <input type="text" wire:model="title_en"
                                    class="w-full border rounded-lg px-3 py-2 mt-1">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['title_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['published_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <div x-show="lang === 'id'">
                                    ...
                                    <div class="mt-3">
                                        <!--[if BLOCK]><![endif]--><?php if($image_id): ?>
                                            <img src="<?php echo e($image_id->temporaryUrl()); ?>"
                                                class="w-20 h-20 rounded-lg object-cover border">
                                        <?php elseif($old_image_id): ?>
                                            <img src="<?php echo e(asset('storage/' . $old_image_id)); ?>"
                                                class="w-20 h-20 rounded-lg object-cover border">
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
                                ...
                                <div x-show="lang === 'en'">
                                    <input type="file" wire:model="image_en"
                                        class="w-full border rounded-lg px-2 py-2 mt-1">
                                    <div class="mt-3">
                                        <!--[if BLOCK]><![endif]--><?php if($image_en): ?>
                                            <img src="<?php echo e($image_en->temporaryUrl()); ?>"
                                                class="w-20 h-20 rounded-lg object-cover border">
                                        <?php elseif($old_image_en): ?>
                                            <img src="<?php echo e(asset('storage/' . $old_image_en)); ?>"
                                                class="w-20 h-20 rounded-lg object-cover border">
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
                    ...
                    <div class="col-span-12 lg:col-span-8 space-y-6">
                        ...
                        <div class="bg-white border rounded-xl p-4">
                            ...
                            <div x-show="lang === 'id'">
                                <?php echo $__env->renderWhen(true, 'front.partials.tinymce-excerpt-id', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                            </div>
                            <div x-show="lang === 'en'">
                                <?php echo $__env->renderWhen(true, 'front.partials.tinymce-excerpt-en', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                            </div>
                        </div>
                        ...
                        <div class="bg-white border rounded-xl p-4">
                            ...
                            <div x-show="lang === 'id'">
                                <?php echo $__env->renderWhen(true, 'front.partials.tinymce-deforestory-laporan-id', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                            </div>
                            <div x-show="lang === 'en'">
                                <?php echo $__env->renderWhen(true, 'front.partials.tinymce-deforestory-laporan-en', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                            </div>
                        </div>
               ...
               text-white px-6 py-2 rounded-lg font-medium flex items-center gap-2">
                            ...
                            <span wire:loading.remove wire:target="save">
                                <?php echo e($laporan ? '💾 Update' : '🚀 Create'); ?>
...
</div><?php /**PATH /Users/aiti/pasopati/resources/views/livewire/deforestory/deforestory-laporan-form.blade.php ENDPATH**/ ?>