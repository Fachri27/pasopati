<div x-show="lang === 'id'" x-data="{
                    excerpt_id: <?php if ((object) ('excerpt_id') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('excerpt_id'->value()); ?>')<?php echo e('excerpt_id'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('excerpt_id'); ?>')<?php endif; ?>,
                    initEditor() {
                        let self = this;
...
</div><?php /**PATH /Users/aiti/pasopati/resources/views/front/partials/tinymce-excerpt-id.blade.php ENDPATH**/ ?>