<div x-show="lang === 'en'" x-data="{
                    excerpt_en: <?php if ((object) ('excerpt_en') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('excerpt_en'->value()); ?>')<?php echo e('excerpt_en'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('excerpt_en'); ?>')<?php endif; ?>,
                    initEditor() {
                        let self = this;
...
</div><?php /**PATH /Users/aiti/pasopati/resources/views/front/partials/tinymce-excerpt-en.blade.php ENDPATH**/ ?>