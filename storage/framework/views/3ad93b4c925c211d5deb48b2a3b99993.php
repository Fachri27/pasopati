<div class="max-w-screen-lg mx-auto">
    <section class="mt-12 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <a href="<?php echo e(route('show-page', ['locale' => app()->getLocale(), 'page_type'=> $item->page_type, 'slug' => $item->slug])); ?>"
                class="group block">
...
</div><?php /**PATH /Users/aiti/pasopati/resources/views/front/components/otherArtikel.blade.php ENDPATH**/ ?>