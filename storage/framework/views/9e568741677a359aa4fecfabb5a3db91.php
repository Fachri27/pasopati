<div class="flex flex-col justify-center items-center">
    <div class="bg-white shadow rounded-lg p-6">
        <div class="flex items-center justify-between ">
            ...
            <a href="<?php echo e(route('fellowship.create')); ?>">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div x-data="{
                dateRange: <?php if ((object) ('dataRange') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('dataRange'->value()); ?>')<?php echo e('dataRange'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('dataRange'); ?>')<?php endif; ?>.defer,
                picker: null,
                init() {
        ...
        <div class="overflow-x-auto">
            <table id="fellowshipTable" class="min-w-full border-collapse table-fixed">
                ...
                <tbody class="text-sm text-gray-700">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $fellowship; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    $idTranslation = $data->translations->firstWhere('locale', 'id');
                    ?>
                    <tr>
                        <td class="p-3"><span class="text-sm leading-snug text-gray-800 block max-w-xs"><?php echo e($idTranslation->title); ?></span></td>
                        <td class="p-3">
                            <img src="<?php echo e(asset('storage/' . $idTranslation->image)); ?>" alt="<?php echo e($idTranslation->title); ?>"
                                class="w-30 h-15">
                        </td>
                        <td class="p-3"><?php echo e($data->start_date); ?></td>
                        <td class="p-3">
                            <!--[if BLOCK]><![endif]--><?php if($data->status === 'active'): ?>
                            <span
                        ...
                        <td class="p-3">
                            <a href="<?php echo e(route('fellowship.preview', ['locale' => 'id', 'slug' => $data->slug])); ?>"
                                target="_blank">
                                <button class="bg-gray-600 px-3 py-1 rounded text-white">Preview</button>
                            </a>
                            <a href="<?php echo e(route('fellowship.edit', $data->id)); ?>">
        ...
        <!-- Pagination -->
        <div class="mt-4">
            <?php echo e($fellowship->links('vendor.pagination.custom')); ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH /Users/aiti/pasopati/resources/views/livewire/fellowship/fellowship-table.blade.php ENDPATH**/ ?>