    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center h-16">
            ...
            <a href="/" class="md:text-2xl text-xl font-bold text-red-600 uppercase text-bold">
                <img src="<?php echo e(asset('img/logo_pasopati.png')); ?>" alt="" class="img-logo md:w-[400px] w-[200px]"
                    id="logo-pasopati">
            </a>
            ...
            <div class="flex items-center space-x-3 ml-5 md:ml-0">
                <form action="<?php echo e(route('search', ['locale' => app()->getLocale()])); ?>" method="get"
                    ...
                    <input type="text" id="search-input-desktop" value="<?php echo e(request('q') ?? request('search') ?? ''); ?>"
                ...
                <div class="flex items-right space-x-1 text-sm">
                    ...
                    <a href="<?php echo e($switchUrl); ?>"
                        class="hover:text-green-900 <?php echo e(app()->getLocale() === 'en' ? 'font-bold text-red-600' : ''); ?>">EN</a>
                    <span>|</span>
                    <a href="<?php echo e($switchUrl); ?>"
                        class="hover:text-green-900 <?php echo e(app()->getLocale() === 'id' ? 'font-bold text-red-600' : ''); ?>">ID</a>
                ...
                <ul class="mt-6 space-y-3">
                    <form action="<?php echo e(route('search', ['locale' => app()->getLocale()])); ?>" method="get"
                        ...
                        <input type="text" id="search-input-mobile"
                            value="<?php echo e(request('q') ?? request('search') ?? ''); ?>" placeholder="Pencarian..." name="q" class="outline-none focus:outline-none focus:ring-0 border-none">
                        <div class="flex">
                    ...
                    <li class="border-b border-black pb-4">
                        ...
                        <ul class="space-y-2">
                            <li class="flex items-center gap-2">
                                ...
                                <a href="<?php echo e(route('artikel.expose', ['locale' => app()->getLocale(), 'expose_type' => 'deforestasi'])); ?>"
                            ...
                            <li class="flex items-center gap-2">
                                <span class="text-red-700 text-xl leading-none">•</span>
                                <a href="<?php echo e(route('artikel.expose', ['locale' => app()->getLocale(), 'expose_type' => 'kebakaran'])); ?>"
                                    class="hover:underline">
                                    Kebakaran
                                </a>
                            </li>
                            ...
                            <li class="flex items-center gap-2">
                                <span class="text-red-700 text-xl leading-none">•</span>
                                <a href="<?php echo e(route('artikel.expose', ['locale' => app()->getLocale(), 'expose_type' => 'pulp'])); ?>"
                                    class="hover:underline">
                                    Pulp & Paper
                                </a>
                            </li>
                            ...
                            <li class="flex items-center gap-2">
                                <span class="text-red-700 text-xl leading-none">•</span>
                                <a href="<?php echo e(route('artikel.expose', ['locale' => app()->getLocale(), 'expose_type' => 'mining'])); ?>"
                                    class="hover:underline">
                                    Mining & Energy
                                </a>
                            </li>
                    ...
                    <li class="border-b border-black">
                        ...
                        <ul>
                            <?php $__currentLoopData = $yearPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year => $posts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <span class="text-red-700 text-xl">•</span>

                                <a
                                    href="<?php echo e(route('fellowship.preview', ['locale' => app()->getLocale(), 'slug' => $post->slug])); ?>">
                                    <?php echo e($year); ?>
                    ...
                    <li class="border-b border-black pb-4">
                        ...
                        <ul>
                            <li class="flex items-center gap-2">
                                <span class="text-red-700 text-xl leading-none">•</span>
                                <a href="<?php echo e(route('petition.index', ['locale' => app()->getLocale()])); ?>"
                                    class="hover:underline">
                                    <?php echo e(app()->getLocale() === 'id' ? 'Petisi Aktif' : 'Active Petitions'); ?>
                    ...
                    <li class="border-b border-black">
                        ...
                        <ul>
                            <li>
                                <span class="text-red-700 text-xl">•</span>
                                <a href="<?php echo e(route('cbi', ['locale' => app()->getLocale()])); ?>">CBI</a>
                            </li>
                            <li>
                                <span class="text-red-700 text-xl">•</span>
                                <a href="#">ANJ</a>
...
</script><?php /**PATH /Users/aiti/pasopati/resources/views/front/components/navbar-user.blade.php ENDPATH**/ ?>